            ...
            <div class="col-md-8">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><a href="">Download full manuscript</a></td>
                ...
                <form action="" method="post" name="submitManuscriptFRM" id="submitManuscriptFRM">
                    <table width="100%" class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td class="font12" height="30" align="center">1.</td>
                                <td class="font12">
                                    Suci P Syahlani<br>
                                ...
                                <td class="font-12">suci.syahlani@ugm.ac.id</td>
                                <td class="font-12">Livestock Social Economics</td>
                                <td class="font-12">Gajah Mada University</td>
                                <td class="font-12">Indonesia</td>
                                <td class="font-12" align="left"><input type="checkbox" name="addReviewers[]"
                                        id="addReviewers" value="221636,sugg">
                                    pref</td>
                            </tr>
