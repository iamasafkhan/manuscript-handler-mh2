                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-12">
                                                <div class="card shadow-lg border-0 rounded-lg">
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('submit-typetitle-abstract') }}"
                                                            method="POST">
                                                            @csrf
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="form-group">
                                                                        <input class="form-control" name="manuscriptTitle"
                                                                            type="text" value="{{ $step2->manuscriptTitle }}" required/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="form-group">
                                                                        <input class="form-control" name="runningTitle"
                                                                            type="text" value="{{ $step2->runningTitle }}" required/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row mt-3">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="form-group"> 
                                                                            <textarea name="manuscriptAbstract" id="manuscriptAbstract" cols="30" rows="10" class="form-control">{{ $step2->manuscriptAbstract }}</textarea>    
                                                                    </div>
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="form-group">
                                                                        <input class="form-control" name="manuscriptAcknowledgement"
                                                                            type="text" value="{{ $step2->manuscriptAcknowledgement	 }}" required/>
                                                                    </div>
                                                                </div>
                                                            </div>
