                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <form action="{{ route('submit-proof-submit') }}" method="post">
                                @csrf
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-12">
                                        <div class="card shadow-lg border-0 rounded-lg">
                                            ...
                                            <div
                                                class="px-2 bg-info text-success card-title d-flex ">
                                                <h3>
                                                    Type Title & Abstract
                                                </h3>
                                                <a
                                            ...
                                            <div class="card-body text-left">
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-9 border">
                                                            <p>{{ $typeTitleAbstract->typeOfManuscript }}</span>                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-center">
                                        {{-- <a href="{{ route('download-pdf', [$company->companySEOURL, $journal->seo, $orderNumber]) }}">add pdf</a> --}}
                    ...
                    <div style="padding: 30px;">
                        {{-- <h4 class="text-center"><b>Manuscript PDF generated file</b></h4> --}}
                            ...
                            <div class="d-flex align-items-stretch button-group">
                                <a href="{{ route('pdf-accept',[$company->companySEOURL, $journal->seo, $orderNumber]) }}" class="btn btn-dark btn-lg px-4">Accept</a>
