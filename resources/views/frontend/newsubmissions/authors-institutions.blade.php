                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card shadow-lg border-0 rounded-lg"
                                                        ...
                                                        <div class="card-body">
                                                                        ...
                                                                        @foreach ($authorinstitution as $author)
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                   ...
                                                                                   <form method="POST" action="{{ route('destroy-author', [$company->companySEOURL, $journal->seo, $author->id]) }}">
                                                                                        @csrf
                                                                                        <button type="submit"
                                                                ...
                                                                <a href="{{ route('reviewer', [$company->companySEOURL, $journal->seo]) }}"
                                                                    name="previous"
        ...
        <div class="modal fade" id="myModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('submit-author-institution') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="authEmailAddress" name="authEmailAddress"
                                    placeholder="Add sub auhtor email address" autocomplete="off" required />

                            </div>
                            <div class="mb-3">

                                <label for="">Title</label>
                                <select name="authTitle" id="authTitle" class="form-control form-select" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="authFirstName" name="authFirstName" required />
                            </div>
                            <div class="mb-3">
                                <label for="">Last Name</label>
                                <input type="text" class="form-control" id="authLastName" name="authLastName" required />
                            </div>

                            <div class="mb-3">
                                <label for="">Affiliation</label>
                                <input type="text" class="form-control" id="authAffiliation" name="authAffiliation" required />
                            </div>


                            <div class="mb-3">
                                <label for="">Country</label>
                                <select name="authCountry" id="authCountry" class="form-control form-select" required>
            ...
            $("#authEmailAddress").change(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var authFirstName = record.firstName;
