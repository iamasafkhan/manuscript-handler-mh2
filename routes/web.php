...
Route::middleware(['auth', 'iseditor'])->group(function(){
    ...
    Route::post('/editor-home/add-reviewers-selected-list/{orderNumber}', [App\Http\Controllers\frontend\Editor\EditorController::class, 'add_reviewers_selected_list'])->name('add-reviewers-selected-list');
